<%@ Page Language="C#" AutoEventWireup="true" CodeFile="DonorLocator.aspx.cs" Inherits="DonorLocator" %>
...
<div style="font-style: normal; font-size: large; background-color: #FFFFFF; color: #000000; font-weight: bold; font-family: Calibri; align: center;">
 ...
 <form id="form2" runat="server">
        ...
        <br />
&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp; &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
        <asp:Button ID="Submit" runat="server" onclick="Submit_Click" Text="Find" />
        <br />
        <br />
        ...
        <br />
        &nbsp; Note : *The Addresses shown above are displayed according to the data given by the donors.
        <br />
        <br />
